...
function WhatWeDo() {
  ...
  return (
    <div id="program" className="relative z-15 min-h-screen flex flex-col gap-10 items-center justify-center w-full mx-auto p-10 bg-slate-100">
      <h1 className="text-6xl font-bold text-red-800 text-center" data-aos="slide">BANNER PROGRAM</h1>
      <h1 className="text-2xl  text-black text-center italic" data-aos="slide" data-aos-delay="200">“Supply Chain Engineering and Logistics Technologies”</h1>
      
      <div className="container mx-auto mt-12 ">
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-12" data-aos="slide-right" data-aos-delay="100">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-12" data-aos="slide-left" data-aos-delay="500">
          <div className="text-justify md:w-1/2">
            <p className="text-xl font-bold text-right">Workplace Safety and Customer Experience Startups</p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-12" data-aos="slide-right" data-aos-delay="1000">
